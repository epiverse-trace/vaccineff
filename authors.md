...
- **International Development Research Center (IDRC)**. Funder.
  [![ROR](https://raw.githubusercontent.com/ror-community/ror-logos/main/ror-icon-rgb.svg)](https://ror.org/0445x0472)
...
- **Érika J Cantor**. Contributor.
  [](https://orcid.org/0000-0003-3320-6032)

- **Santiago Loaiza**. Contributor.
  [](https://orcid.org/0000-0002-2092-3262)

- **Jaime Pavlich-Mariscal**. Contributor, maintainer.
...
Based on Different Study Designs*. R package version 1.0.3,
