...
```
For details on the estimation of VE in cohort studies see the [Introduction to cohort design with vaccineff](https://trace-lac.github.io/vaccineff/articles/cohort_design.html)
